"""
Outline-77 ComfyUI Node - Fixed Version
File: outline_node.py
Directory: ComfyUI/custom_nodes/Alo77/outline77/
"""
...
class Outline77:
    ...
    Optimized for ComfyUI tensor format and API requirements.
    """
    ...
    def create_outline(self, image, outline_color, outline_width, softness, grow_shrink, round_corners, keep_alpha):
        """
        Create outlined image optimized for ComfyUI.
        """
        try:
...
# Node Registration
NODE_CLASS_MAPPINGS = {
    "Outline-77": Outline77
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "Outline-77": "Outline-77 🎨"
}